...
contract Review {
    ...
    function add_voting(uint _review_id, bool _a_d, address _voter) public{
        if (_a_d){
    ...
    function view_voting(uint _review_id) public view returns (address[] memory, address[] memory, uint8){
    ...
    function add_review(uint _review_id, string memory _place, string memory _title, string memory _content, address _writer) public {
    ...
    function view_review(uint _review_id) public view returns (string memory, string memory, string memory, address){
